...
class SearchViewModel @Inject constructor(
    ...
    val pagingDataFlow: Flow<PagingData<SearchArtist>>
    ...
    private fun searchArtist(queryString: String): Flow<PagingData<SearchArtist>> = repo.getSearchArtist(queryString)
}
